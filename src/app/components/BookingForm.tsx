  ...
  return (
    <form action={booking ? updateBooking : createBooking} className="card form">
      ...
      <div className="grid two">
        ...
        <div className="field"><label htmlFor="checkIn">Check-in</label><input id="checkIn" name="checkIn" type="date" defaultValue={booking ? formatCalendarDateInput(booking.checkIn) : ""} required /></div>
        <div className="field"><label htmlFor="checkOut">Check-out</label><input id="checkOut" name="checkOut" type="date" defaultValue={booking ? formatCalendarDateInput(booking.checkOut) : ""} required /></div>
        ...
        <div className="field"><label htmlFor="cancellationDeadline">Cancellation deadline</label><input id="cancellationDeadline" name="cancellationDeadline" type="datetime-local" defaultValue={booking ? formatLocalInstantInput(booking.cancellationDeadline) : ""} /></div>
